      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 lg:space-y-8 order-1 lg:order-2">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-primary mb-3 lg:mb-4 leading-tight">
                স্বাগতম
                <span className="block text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-foreground mt-1">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
              <Card className="bg-white/50 border-primary/20">
                <CardContent className="p-3 lg:p-4 text-center">
                  ...
                  <div className="text-lg lg:text-2xl font-bold text-primary">২০০৫</div>
                  <div className="text-xs lg:text-sm text-muted-foreground">প্রতিষ্ঠিত</div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/50 border-primary/20">
                <CardContent className="p-3 lg:p-4 text-center">
                  ...
                  <div className="text-lg lg:text-2xl font-bold text-primary">১২০০+</div>
                  <div className="text-xs lg:text-sm text-muted-foreground">শিক্ষার্থী</div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/50 border-primary/20">
                <CardContent className="p-3 lg:p-4 text-center">
                  ...
                  <div className="text-lg lg:text-2xl font-bold text-primary">৬০+</div>
                  <div className="text-xs lg:text-sm text-muted-foreground">শিক্ষক</div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/50 border-primary/20">
                <CardContent className="p-3 lg:p-4 text-center">
                  ...
                  <div className="text-lg lg:text-2xl font-bold text-primary">৯৮%</div>
                  <div className="text-xs lg:text-sm text-muted-foreground">পাসের হার</div>
                </CardContent>
              </Card>
            </div>
          </div>
