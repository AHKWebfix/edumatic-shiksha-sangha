          ...
          <div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/80 text-sm">০১৮৮১-৫৯১৩১২</span>
              </div>
        ...
        <div className="border-t border-white/20 mt-8 sm:mt-12 pt-6 sm:pt-8">
          ...
          <div className="text-center mt-4 sm:mt-6">
            <p className="text-xs text-slate-50">
              Design & Developed by{" "}
              <a href="https://wa.me/8801881591312" target="_blank" rel="noopener noreferrer" className="hover:text-white underline transition-colors">
